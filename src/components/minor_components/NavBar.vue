...
const links = [
    {
        href: 'https://github.com/AleScla',
        label: 'My GitHub'
    },
    {
        href: 'https://www.linkedin.com/in/AleScla',
        label: 'My Linkedin'
    },
...
<template>
  <Disclosure as="nav" class="bg-gray-800 h-16" v-slot="{ open }">
      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <Menu as="div" class="relative ml-3">
            <div>
              <MenuButton id="menubutton" class="relative flex items-center rounded-full bg-gray-600 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                <span class="absolute -inset-1.5" />
                <span class="sr-only">Open user menu</span>
                <span id="my-links" class="px-2 text-gray-300 font-medium ">My Links</span>
                <img class="size-8 rounded-full" src="/public/profile-pic.jpeg" alt="profile-pic" />
              </MenuButton>
            </div>
